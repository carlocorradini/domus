...
#define MESSAGE_TYPE_SPAWN_DEVICE 5
#define MESSAGE_TYPE_SET_INIT_VALUES 6
#define MESSAGE_TYPE_LOCK 7
#define MESSAGE_TYPE_UNLOCK 8
#define MESSAGE_TYPE_UNLOCK_AND_DELETE 9
