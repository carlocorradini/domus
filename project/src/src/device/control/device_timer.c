...
int main(int argc, char **args) {
    ...
    control_device_fork(hub, 29, device_is_supported_by_id(1));
    control_device_fork(hub, 30, device_is_supported_by_id(1));
    control_device_fork(hub, 31, device_is_supported_by_id(1));
